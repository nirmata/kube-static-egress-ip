...
WORKDIR /workspace/golang/src/github.com/nirmata/kube-static-egress-ip/cmd/static-egressip-gateway-manager/
...
WORKDIR /root/
COPY --from=builder /workspace/golang/bin/static-egressip-gateway-manager /usr/local/bin/static-egressip-gateway-manager

ENTRYPOINT ["/usr/local/bin/static-egressip-gateway-manager"]